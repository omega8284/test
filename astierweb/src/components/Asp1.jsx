...
import aspp from "../images/ASP1.jpg";
...
const Asp1 = () => {
  ...
  return (
    ...
    <div class="wrapper indent-top">
      <article className="grid_15 suffix_1 prefix_1 alpha"><h2 style={{color: "blueviolet"}}>
     ASP 
     <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/asp2">Next</Link></Button></h2>
        <img src={aspp} alt="aspp" style={{width: "900px", height: "auto"}} />
      </article>
    </div>
