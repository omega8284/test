...
import fron from "../images/front.jpg";
    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/overview">Next</Link></Button></h2>
                    <img src={fron} alt="fron" style={{ width: "880px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
