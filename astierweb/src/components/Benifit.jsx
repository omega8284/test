...
import beni from "../images/benifits.jpg";
    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
                <Button variant="outline-info" style={{}}><Link to="/education">Previous</Link></Button>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/connect">Next</Link></Button></h2>
                    <img src={beni} alt="beni" style={{ width: "880px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
