...
const Adjava = () => {
  ...
  return (
    ...
    <div class="wrapper indent-top">
      <article className="grid_15 suffix_1 prefix_1 alpha"><h2>
      <Link to="/java" style={{color: "rosybrown"}}> CORE </Link> / <Link to="/advance"  style={{color: "rosybrown"}} >ADVANCE</Link>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/next">Next</Link></Button></h2>
        <img src={java} alt="java" style={{width: "999px", height: "auto"}} />
      </article>
    </div>
    <footer>
        <aside>
