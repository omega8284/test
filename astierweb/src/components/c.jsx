...
import clang from "../images/clang.jpg";
...
const CC = () => {
  ...
  return (
    ...
    <div class="wrapper indent-top">
      ...
      <Link to="/c" style={{color: "rosybrown"}}> C LANGUAGE </Link> / <Link to="/cpp"  style={{color: "rosybrown"}} >C++ LANGUAGE</Link></h2>
        <img src={clang} alt="clang" style={{width: "999px", height: "auto"}} />
      </article>
    </div>
