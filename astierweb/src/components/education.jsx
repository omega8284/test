    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
                <Button variant="outline-info" style={{}}><Link to="/training">Previous</Link></Button>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/benifits">Next</Link></Button></h2>
                    <img src={educ} alt="educ" style={{ width: "1000px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
