    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
                <Button variant="outline-info" style={{}}><Link to="/overview">Previous</Link></Button>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/education">Next</Link></Button></h2>
                    <img src={it} alt="it" style={{ width: "1000px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
