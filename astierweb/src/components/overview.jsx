...
import asso from "../images/association.jpg";
    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
                <Button variant="outline-info" style={{}}><Link to="/association">Previous</Link></Button>
       <Button variant="outline-info" style={{marginLeft: "750px"}}><Link to="/training">Next</Link></Button></h2>
                    <img src={asso} alt="asso" style={{ width: "880px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
