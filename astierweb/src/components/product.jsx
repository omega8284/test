...
import all from "../images/all images.jpg";
...
const Products = () => {
  ...
  return (
    <div>
       <div class="wrapper indent-top" style={{ maxWidth: '100%', overflow: 'hidden' }}>
       <img src={all} alt="Your c"  style={{ width: "850px", height: 'auto', border: 'none', display: 'block' }}  />
       </div>
       <footer>
        <aside>
