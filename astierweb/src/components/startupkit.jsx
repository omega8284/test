...
import star from "../images/startup.jpg";
    ...
    return (
        <div>
            <div class="wrapper indent-top">
                ...
                <h2>
                <Button variant="outline-info" style={{}}><Link to="/connect">Previous</Link></Button>
       </h2>
                    <img src={star} alt="star" style={{ width: "880px", height: "auto", marginTop: "10px" }} />
                </article>
            </div>
