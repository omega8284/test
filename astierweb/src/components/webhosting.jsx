...
import wd2 from "../images/webdesign2.jpg";
...
const Wd2 = () => {
  ...
  return (
    ...
    <div class="wrapper indent-top">
      ...
      <Link to="/web-hosting" style={{color: "rosybrown"}}> WEB-DESIGNING </Link> / <Link to="/web-designing"  style={{color: "rosybrown"}} >ADVANCE</Link></h2>
        
        <img src={wd2} alt="wd2" style={{width: "950px", height: "auto", marginTop: "25px"}} />
      </article>
    </div>
